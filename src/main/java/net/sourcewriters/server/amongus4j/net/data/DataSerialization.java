...
import net.sourcewriters.server.amongus4j.utils.JavaHelper;
...
public final class DataSerialization {
	...
	public static byte[] fromString(final String value, final Charset charset) {
	...
	public static String asString(final byte[] bytes, final Charset charset) {
	...
	public static double[] asDoubleArray(byte[] bytes) {
		byte[][] part = JavaHelper.partition(bytes, Long.BYTES);
	...
	public static float[] asFloatArray(byte[] bytes) {
		byte[][] part = JavaHelper.partition(bytes, Integer.BYTES);
	...
	public static short[] asShortArray(byte[] bytes) {
		byte[][] part = JavaHelper.partition(bytes, Short.BYTES);
